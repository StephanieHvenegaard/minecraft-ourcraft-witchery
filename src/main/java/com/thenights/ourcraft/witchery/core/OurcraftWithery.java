...
@Mod(OurcraftWithery.MODID)
public class OurcraftWithery
{
    public static OurcraftWithery INSTANCE;                                             // public instance of the main mod class
